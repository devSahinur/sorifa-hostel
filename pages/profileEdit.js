    ...
    <div>
      ...
      <div className="flex items-center justify-center">
        <img
          ...
          src="https://i.ibb.co/MRX27MK/images.png"
          alt=""
        />
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <label className="mb-2 block text-gray-600">Department</label>
                <select
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div>
                <label className="mb-2 block text-gray-600">Phone Number</label>
                <input
                  type="number"
                  className="input-box"
              ...
              <div>
                <label className="mb-2 block text-gray-600">Collage Name</label>
                <select
